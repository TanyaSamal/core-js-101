...
function encodeToRot13(str) {
  ...
  str.split('').forEach((char) => {
    ...
    let outputChar = '';
    if (arr1.includes(char.toLowerCase())) {
      outputChar = arr2[arr1.indexOf(char.toLowerCase())];
    }
    if (arr2.includes(char.toLowerCase())) {
      outputChar = arr1[arr2.indexOf(char.toLowerCase())];
    }
    if (outputChar === '') outputChar = char;
    srtOutput += isUpperCase ? outputChar.toUpperCase() : outputChar;
  });
  return srtOutput;
}
